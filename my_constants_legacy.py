...
EDA_SUB_FEATURES = ['eda_eda_24hrs_mean_difference_r_l',
                    ...
                    'eda_recording_time_fraction_24hrs_left',
                    'eda_recording_time_fraction_24hrs_merged',
                    'eda_recording_time_fraction_24hrs_right',
                    'eda_recording_time_fraction_night_left',
                    'eda_recording_time_fraction_night_merged',
                    'eda_recording_time_fraction_night_right']

EDA_SUB_FEATURES2 = ['eda_eda_24hrs_mean_difference_r_l',
                     'eda_eda_24hrs_scrs_diff_r_l',
                     'eda_eda_24hrs_scrs_mean_ampl_diff_r_l',
                     'eda_eda_night_scrs_mean_ampl_left',
                     'eda_eda_night_scrs_mean_ampl_right']
